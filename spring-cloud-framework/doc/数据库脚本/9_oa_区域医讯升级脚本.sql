...
where table_schema = 'spring-cloud-framework-new'
...
-- ------------------------------------------------------------------------------------------------------------------------------------------------------
-- 修改表名
alter table oa_sms_template drop column template_type;
alter table oa_sms_template drop column status;
alter table oa_sms_template add channel varchar(128) null comment '短信通道' after org_id;
rename table oa_sms_template to msg_sms_template;
