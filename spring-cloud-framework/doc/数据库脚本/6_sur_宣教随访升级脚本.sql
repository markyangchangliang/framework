...
-- ------------------------------------------------------------------------------------------------------------------------------------------------------
-- 调查问卷答案字段新增
ALTER TABLE `spring-cloud-framework`.`sur_answer`
ADD COLUMN `created_by` varchar(128) NULL COMMENT '创建人ID' AFTER `last_modified_by`,
ADD COLUMN `created_datetime` datetime(0) NULL COMMENT '创建时间' AFTER `created_by`;
