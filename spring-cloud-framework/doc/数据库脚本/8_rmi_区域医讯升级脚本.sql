...
-- ------------------------------------------------------------------------------------------------------------------------------------------------------
-- 修改表名
rename table cou_news to rmi_news;
rename table cou_news_viewer to rmi_news_viewer;
rename table cou_news_comment to rmi_news_comment;
alter table rmi_news change pub_status publish_status char not null comment '发布状态';
alter table rmi_news change pub_date publish_date datetime not null comment '发布日期';
