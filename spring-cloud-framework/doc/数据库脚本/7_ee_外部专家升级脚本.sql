rename table eec_expert to ee_expert;
...
-- ------------------------------------------------------------------------------------------------------------------------------------------------------
-- 修改表名
alter table ee_expert modify positional varchar(128) null comment '职称';
alter table ee_expert modify post varchar(128) null comment '职务';
alter table ee_expert change intro introduction varchar(2048) null comment '简介';
alter table ee_expert change mphone mobile_phone varchar(32) not null comment '联系电话';
alter table ee_expert change weixin wx varchar(128) null comment '微信';
alter table ee_clinic change res_begin_date reservation_begin_date datetime not null comment '预约开始时间';
alter table ee_clinic change res_end_date reservation_end_date datetime not null comment '预约结束时间';
alter table ee_clinic modify fee decimal(8,2) not null comment '诊查费';
