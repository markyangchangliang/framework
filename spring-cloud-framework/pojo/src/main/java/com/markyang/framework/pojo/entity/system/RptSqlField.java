...
@AllArgsConstructor
@NoArgsConstructor
@TableName("`sys_rpt_sql_field`")
public class RptSqlField extends AbstractBaseEntity {

    private static final long serialVersionUID = -35685743305049113L;
