...
public abstract class AbstractFrameworkTokenGranter extends AbstractTokenGranter {
    ...
    protected AbstractFrameworkTokenGranter(AuthenticationManager authenticationManager, AuthorizationServerTokenServices tokenServices,
    ...
    protected OAuth2Authentication getOAuth2Authentication(ClientDetails client, TokenRequest tokenRequest) {
        ...
        Authentication userAuth = this.extractAuthentication(parameters);
