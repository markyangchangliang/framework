...
@JsonComponent
@Slf4j
public class LocalDateRangeDeserializer extends StdDeserializer<LocalDateRange> {

    protected LocalDateRangeDeserializer() {
     ...
     */
    @Override
    public LocalDateRange deserialize(JsonParser p, DeserializationContext ctxt) throws IOException, JsonProcessingException {
        ...
        log.error("解析LocalDateRange失败：" + p.getValueAsString());
        return null;
    }
}
