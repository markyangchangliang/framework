 ...
 */
@ApiModel(value = "角色管理搜索表单", description = "角色管理搜索表单类")
@NoArgsConstructor
@SuperBuilder
@Data
public class RoleSearchForm implements SearchBaseForm {
     ...
     * 下拉选参数
     */
    @ApiModelProperty(value = "下拉选参数", allowableValues = "", required = true, position = 1)
